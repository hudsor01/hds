...
export class WaitlistPositionService {
   ...
   */
  static async updatePositions(updates: {email: string; newPosition: number}[]): Promise<void> {
   ...
   */
  static async moveToPosition(email: string, newPosition: number): Promise<void> {
