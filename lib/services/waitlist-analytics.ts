...
export async function getWaitlistStats(
  ...
  return {
    ...
    referrals: Array.from(referralStats.entries()).map(
      ([code, { email, count }]) => ({
        code,
...
export async function updateWaitlistPosition(
  ...
  await trackWaitlistEvent(email, 'position_updated', {
