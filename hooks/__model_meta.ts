...
const metadata = {
    models: {
        users: {
            name: 'users', fields: {
                id: {
                    ...
                    type: "String",
                    isOptional: true,
                    attributes: [{ "name": "@default", "args": [{ "value": "inactive" }] }],
                }, sessions: {
                    name: "sessions",
                    type: "session",
                    isDataModel: true,
        ...
        properties: {
            name: 'properties', fields: {
                id: {
                    ...
                    name: "property_type",
                    type: "String",
                    attributes: [{ "name": "@default", "args": [{ "value": "Residential" }] }],
                }, rent_amount: {
                    name: "rent_amount",
                    type: "Decimal",
                }, user_id: {
        ...
        ,
        maintenance_requests: {
            name: 'maintenance_requests', fields: {
                id: {
                    name: "id",
                    type: "String",
                    isId: true,
                    ...
                    name: "priority",
                    type: "String",
                    attributes: [{ "name": "@default", "args": [{ "value": "LOW" }] }],
                }, created_at: {
                    name: "created_at",
                    type: "DateTime",
                    attributes: [{ "name": "@default", "args": [] }],
        ...
        password_reset_requests: {
            name: 'password_reset_requests', fields: {
                id: {
                    name: "id",
                    type: "String",
                    isId: true,
        ...
        ,
        security_audit_log: {
            name: 'security_audit_log', fields: {
                id: {
                    name: "id",
                    type: "String",
                    isId: true,
        ...
        system_configurations: {
            name: 'system_configurations', fields: {
                id: {
                    name: "id",
                    type: "String",
                    isId: true,
        ...
        ,
        user_activity_logs: {
            name: 'user_activity_logs', fields: {
                id: {
                    name: "id",
                    type: "String",
                    isId: true,
        ...
        user_profiles: {
            name: 'user_profiles', fields: {
                id: {
                    ...
                    type: "String",
                    isOptional: true,
                    attributes: [{ "name": "@default", "args": [{ "value": "UTC" }] }],
        ...
        user_security_settings: {
            name: 'user_security_settings', fields: {
                user_id: {
                    name: "user_id",
                    type: "String",
                    isId: true,
        ...
        user_settings: {
            name: 'user_settings', fields: {
                id: {
                    ...
                    type: "String",
                    isOptional: true,
                    attributes: [{ "name": "@default", "args": [{ "value": "light" }] }],
                }, language: {
                    name: "language",
                    type: "String",
                    isOptional: true,
                    attributes: [{ "name": "@default", "args": [{ "value": "en" }] }],
                }, currency: {
                    name: "currency",
                    type: "String",
                    isOptional: true,
                    ...
                    type: "String",
                    isOptional: true,
                    attributes: [{ "name": "@default", "args": [{ "value": "MM/DD/YYYY" }] }],
                }, time_format: {
                    name: "time_format",
                    type: "String",
                    isOptional: true,
                    attributes: [{ "name": "@default", "args": [{ "value": "12h" }] }],
        ...
        ,
        verification_tokens: {
            name: 'verification_tokens', fields: {
                identifier: {
                    name: "identifier",
                    type: "String",
                    isId: true,
        ...
        organization_members: {
            name: 'organization_members', fields: {
                id: {
                    name: "id",
                    type: "String",
                    isId: true,
                    ...
                    type: "String",
                    isOptional: true,
                    attributes: [{ "name": "@default", "args": [{ "value": "'member'" }] }],
                }, updated_at: {
                    name: "updated_at",
                    type: "DateTime",
                    isOptional: true,
        ...
        inspections: {
            name: 'inspections', fields: {
                id: {
                    ...
                    name: "status",
                    type: "String",
                    attributes: [{ "name": "@default", "args": [{ "value": "SCHEDULED" }] }],
                }, scheduled_date: {
                    name: "scheduled_date",
                    type: "DateTime",
                }, completed_date: {
        ...
        stripe_webhook_events: {
            name: 'stripe_webhook_events', fields: {
                id: {
                    name: "id",
                    type: "String",
                    isId: true,
