      ...
      <div className="container mx-auto px-6 py-10">
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-12 xl:grid-cols-3 xl:gap-12">
          {features.map(feature => (
            <div key={feature.name} className="space-y-3 rounded-xl border-2 border-blue-200 p-8 dark:border-blue-300">
              <span className="inline-block text-blue-400 dark:text-blue-300">
                <feature.icon />
              </span>

              <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">{feature.name}</h1>
