  ...
  const metrics = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        color: property.pending_maintenance === 0
          ? 'success'
          : property.pending_maintenance <= 2
            ? 'warning'
            : 'error'
      },
      {
        ...
        color: property.annual_roi >= 8
          ? 'success'
          : property.annual_roi >= 5
            ? 'warning'
            : 'error'
      },
      {
        ...
        tooltip: property.status === 'rented'
        ...
        <Grid item xs={12} sm={6} md={4} key={metric.key}>
          <Card
            className={cn(
              ...
              onMetricClick && 'cursor-pointer hover:shadow-md'
            )}
            ...
            <CardContent>
              <Stack spacing={2}>
                ...
                <Typography variant="h6" className="font-semibold">
                  {loading ? (
                    <Box className="h-6 w-24 animate-pulse rounded bg-gray-200" />
                  ) : (
                    metric.value
                  )}
                </Typography>
