...
export default function PaymentMethodForm({ onSuccess, onCancel, defaultType = 'card' }: PaymentMethodFormProps) {
    ...
    <Box component="form" onSubmit={handleSubmit} sx={{ width: '100%', maxWidth: 400 }}>
      ...
      <FormControl fullWidth sx={{ mb: 3 }}>
        ...
        <Select
          ...
          label="Payment Type"
          onChange={e => {
            setPaymentType(e.target.value as PaymentMethodType)
          }}
        >
      ...
      {paymentType === 'card' ? (
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mb: 3 }}>
          ...
          {paymentType === 'ach_debit' && (
            <>
              <TextField label="Bank Name" name="bank_name" value={formData.bank_name} onChange={handleInputChange} required />
              <TextField
          ...
          {paymentType === 'check' && (
            <>
              ...
              <TextField
                ...
                required
              />
              <TextField label="Check Number" name="check_number" value={formData.check_number} onChange={handleInputChange} />
            </>
          )}
          ...
          {paymentType === 'cash' && (
            <>
              <TextField
                ...
                onChange={handleInputChange}
              />
              <TextField label="Received By" name="received_by" value={formData.received_by} onChange={handleInputChange} />
              <TextField label="Notes" name="notes" value={formData.notes} onChange={handleInputChange} multiline rows={3} />
            </>
          )}
          ...
          {paymentType === 'bank_transfer' && (
            <>
              ...
              <TextField
                ...
                required
              />
              <TextField label="SWIFT/BIC" name="swift_bic" value={formData.swift_bic} onChange={handleInputChange} />
              <TextField label="IBAN" name="iban" value={formData.iban} onChange={handleInputChange} />
              <TextField label="Reference" name="reference" value={formData.reference} onChange={handleInputChange} />
            </>
          )}
        </Box>
      )}
