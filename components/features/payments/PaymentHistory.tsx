                ...
                <TableRow key={payment.id}>
                  ...
                  {permissions.canViewAllProperties && (
                    <>
                      ...
                      <TableCell>${((payment.payment_amount || 0) + (payment.late_fee || 0)).toFixed(2)}</TableCell>
                    </>
                  )}
                  ...
                  {permissions.canViewAllProperties && (
                    <>
                      ...
                      <TableCell>{payment.tenant ? `${payment.tenant.first_name} ${payment.tenant.last_name}` : '-'}</TableCell>
                    </>
                  )}
                </TableRow>
              ))
