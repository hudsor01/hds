...
interface MaintenanceTrackerProps {
  ...
  onViewRequestAction: (request: MaintenanceRequest) => void
}

export function MaintenanceTracker({ requests, onViewRequestAction }: MaintenanceTrackerProps) {
