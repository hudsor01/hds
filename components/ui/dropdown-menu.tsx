...
export const DropdownMenuSeparator = React.forwardRef<HTMLHRElement, React.ComponentProps<typeof Divider>>(
  ({ className, ...props }, ref) => (
    <Divider ref={ref} component="hr" className={cn('bg-muted -mx-1 my-1 h-px', className)} {...props} />
  )
)
