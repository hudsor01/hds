...
export function AnimatedButton({ children, isLoading }: { children: React.ReactNode; isLoading?: boolean }) {
  return (
    <motion.div variants={formVariants.button} animate={isLoading ? 'loading' : ''} whileTap="tap" whileHover="hover">
