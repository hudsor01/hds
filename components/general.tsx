...
import { Box, FormControl, FormGroup, FormHelperText, MenuItem, Select, Typography } from '@mui/material'
      ...
      <FormGroup sx={{ gap: 3 }}>
        <FormControl>
          <Typography variant="subtitle2" gutterBottom>
            Theme
          <Select value={theme} onChange={(e: SelectChangeEvent<typeof theme>) => setTheme(e.target.value)} size="small">
          >
