  ...
  return (
    <MuiCard
      className={cn(
        ...
        highlighted ? 'border-primary scale-105 shadow-lg hover:shadow-xl' : 'hover:border-primary/50 hover:shadow-md'
      )}
    >
      {highlighted && (
      ...
      <MuiCardActions>
        <MuiButton
          ...
          className={cn('w-full transition-colors', highlighted ? 'bg-primary text-primary-foreground hover:bg-primary/90' : '')}
