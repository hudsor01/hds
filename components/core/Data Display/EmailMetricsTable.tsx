...
import { DataGrid, type GridColDef, type GridRenderCellParams, type GridValueFormatterParams } from '@mui/x-data-grid'
    ...
    const columns: GridColDef<EmailMetrics>[] = React.useMemo(
      () => [
        ...
        },
        {
          ...
          width: 120,
          type: 'number',
          valueFormatter: (params: GridValueFormatterParams<number>) => formatPercentage(params.value),
