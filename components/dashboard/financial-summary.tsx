                        ...
                        <div className="bg-background rounded-lg border p-2 shadow-sm">
                          <div className="grid grid-cols-2 gap-2">
                            <div className="flex flex-col">
                              ...
                              <span className="font-bold text-blue-500">{formatCurrency(payload[0].value)}</span>
                            </div>
                            <div className="flex flex-col">
                              <span className="text-muted-foreground font-bold">Expenses</span>
                              <span className="font-bold text-red-500">{formatCurrency(payload[1].value)}</span>
                              <span className="text-muted-foreground font-bold">Net Income</span>
                              <span className="font-bold text-green-500">{formatCurrency(payload[2].value)}</span>
                            </div>
                          </div>
                        </div>
                      )
