const __vite__mapDeps = (
    ...
    d = m.f ||
        (m.f = [
            './assets/xtermModule-c-SNdYZy.js',
...
import {
    ...
    c as Xt,
    d as Jt
} from './assets/defaultSettingsView-5nVJRt0A.js'
var Zt = {}
class ot {
    constructor(t, e = {}) {
        ;(this.isListing = !1),
    ...
    _onProject(t) {
        let e = this._options.mergeProjects
            ? this._rootSuite.suites.find(
                  s => s.project().name === t.name
              )
            : void 0
        e ||
            ((e = new Q(t.name, 'project')),
            this._rootSuite._addSuite(e)),
            (e._project = this._parseProject(t))
        for (const s of t.suites) this._mergeSuiteInto(s, e)
    }
    _onBegin() {
        var t, e
        ;(e = (t = this._reporter).onBegin) == null ||
            e.call(t, this._rootSuite)
    }
    _onTestBegin(t, e) {
        var c, a
        const s = this._tests.get(t)
        this._options.clearPreviousResultsWhenTestBegins &&
            (s.results = [])
        ...
        ;(r.retry = e.retry),
            ...
            (a = (c = this._reporter).onTestBegin) == null ||
                a.call(c, s, r)
    }
    _onTestEnd(t, e) {
        var c, a, g
        ...
        ;(r.duration = e.duration),
            ...
            (g = (a = this._reporter).onTestEnd) == null ||
                g.call(a, s, r),
            (r._stepMap = new Map())
    }
    _onStepBegin(t, e, s) {
    ...
    _onStepEnd(t, e, s) {
        ...
        ;(a._endPayload = s),
            ...
            (a.error = s.error),
            (l = (g = this._reporter).onStepEnd) == null ||
                l.call(g, r, c, a)
    }
    _onError(t) {
        var e, s
    ...
    _onStdIO(t, e, s, r, c) {
        ...
        t === 'stdout'
            ? (l == null || l.stdout.push(a),
              (n = (_ = this._reporter).onStdOut) == null ||
                  n.call(_, a, g, l))
            : (l == null || l.stderr.push(a),
              (v = (h = this._reporter).onStdErr) == null ||
                  v.call(h, a, g, l))
    }
    async _onEnd(t) {
        var e, s
    ...
    _onExit() {
        var t, e
        return (e = (t = this._reporter).onExit) == null
            ? void 0
            : e.call(t)
    }
    _parseConfig(t) {
    ...
    _mergeSuiteInto(t, e) {
        ...
        s ||
            ((s = new Q(
                t.title,
                e.type === 'project' ? 'file' : 'describe'
            )),
            e._addSuite(s)),
            (s.location = this._absoluteLocation(t.location)),
            t.entries.forEach(r => {
                'testId' in r
                    ? this._mergeTestInto(r, s)
                    : this._mergeSuiteInto(r, s)
            })
    }
    _mergeTestInto(t, e) {
        let s = this._options.mergeTestCases
            ? e.tests.find(
                  r =>
                      r.title === t.title &&
                      r.repeatEachIndex === t.repeatEachIndex
              )
            : void 0
        s ||
            ((s = new Gt(
...
class Q {
    ...
    titlePath() {
        ...
        return (
            (this.title || this._type !== 'describe') &&
                t.push(this.title),
            t
        )
    }
    project() {
        ...
        return (
            this._project ??
            ((t = this.parent) == null ? void 0 : t.project())
        )
    }
    _addTest(t) {
    ...
    constructor(t, e, s, r, c) {
        ...
        const g = (l, _, n) => {
            ...
            for (const h of _.tests) {
                const v = h.title
                let d = n.children.find(
                    C => C.kind !== 'group' && C.title === v
                )
                d ||
                    ((d = {
                        kind: 'case',
                ...
                const B = {
                    ...
                    children: [],
                    status: x,
                    duration: h.results.length
                        ? Math.max(0, h.results[0].duration)
                        : 0,
                    project: l
                }
                this._addChild(d, B),
                    this._treeItemByTestId.set(h.id, B),
                    (d.duration = d.children.reduce(
                        (C, j) => C + j.duration,
                        0
                    ))
            }
        ...
        for (const l of (e == null ? void 0 : e.suites) || [])
            if (!(a && !r.get(l.title)))
                for (const _ of l.suites) {
                    const n = this._fileItem(
                        _.location.file.split(c),
                        !0
                    )
                    g(l.project(), _, n)
                }
            ...
            g = l => {
                ...
                for (const n of l.children)
                    n.kind === 'case'
                        ? a(n) && _.push(n)
                        : (g(n),
                          (n.children.length || n.hasLoadErrors) &&
                              _.push(n))
                l.children = _
            }
        g(this.rootItem)
...
class oe {
                ...
                ;(this.config = t),
                    (this._lastRunReceiver = new ot(
                        ...
                        },
                        {
                            ...
                            mergeTestCases: !1,
                            resolvePath: (e, s) =>
                                e + this._options.pathSeparator + s
                        }
                    ))
            },
            onBegin: t => {
                var e
                if (
                    (this.rootSuite || (this.rootSuite = t),
    ...
    processListReport(t) {
        var s
        const e =
            ((s = this.rootSuite) == null ? void 0 : s.allTests()) ||
            []
        ;(this._testResultsSnapshot = new Map(
            e.map(r => [r.id, r.results])
        )),
    ...
    processTestReportEvent(t) {
        var e, s, r
        ;(s =
            (e = this._lastRunReceiver) == null
                ? void 0
                : e.dispatch(t)) == null || s.catch(() => {}),
            (r = this._receiver.dispatch(t)) == null ||
                r.catch(() => {})
    }
    _handleOnError(t) {
        var e, s
...
const ne = ({ source: i }) => {
        const [t, e] = Lt(),
            ...
            [c] = K.useState(
                Dt(
                    () => import('./assets/xtermModule-c-SNdYZy.js'),
                    __vite__mapDeps([0, 1]),
                    import.meta.url
                ).then(g => g.default)
            ),
            ...
            K.useEffect(() => {
                ...
                return (
                    (async () => {
                        ...
                        if (
                            a.current &&
                            a.current.terminal.options.theme === v
                        )
                            return
            ...
            K.useEffect(() => {
                setTimeout(() => {
                    a.current &&
                        ...
                        i.resize(
                            a.current.terminal.cols,
                            a.current.terminal.rows
                        ))
                }, 250)
            }, [t, i]),
            o.jsx('div', {
...
Projects: ` +
    ...
    de = ({ tag: i, style: t, onClick: e }) =>
        o.jsx('span', {
            className: at('tag', `tag-color-${ue(i)}`),
            onClick: e,
    ...
    fe = ({
        ...
        u.useEffect(() => {
            if (W !== h) {
                ...
                for (const b of s.flatTreeItems())
                    x.expandedItems.set(b.id, !1)
                F(h), j(void 0), B({ ...x })
                return
            }
            if ($ !== v) {
...
const me = ({
        ...
        const [c, a] = u.useState(),
            ...
            { outputDir: n } = u.useMemo(
                () => ({
                    outputDir: i.testCase ? _e(i.testCase) : void 0
                }),
                [i]
            )
        return (
            u.useEffect(() => {
                ...
                const d =
                    (B = i.testCase) == null ? void 0 : B.results[0]
                if (!d) {
                    a(void 0)
                    return
                }
                const S =
                    d &&
                    d.duration >= 0 &&
                    d.attachments.find(j => j.name === 'trace')
                if (S && S.path) {
            ...
            o.jsx(
                Vt,
                {
                    ...
                    status:
                        (h = i.treeItem) == null ? void 0 : h.status,
                    annotations:
                        ((v = i.testCase) == null
                            ? void 0
                            : v.annotations) || [],
...
const z = {
    ...
    we = new URL(O.get('server') ?? '../', window.location.href),
    lt = new URL(O.get('ws'), we)
                ...
                return (
                    ...
                    (async () => {
                        try {
                            ...
                            const { status: T, report: y } =
                                await w.runGlobalSetup({})
                            if (
                                (m.processGlobalReport(y),
                                T !== 'passed')
                            )
                                return
        ...
        const { testTree: Ct } = u.useMemo(() => {
                ...
                return (
                    p.filterTree(
                        i,
                        a,
                        N ? (F == null ? void 0 : F.testIds) : void 0
                    ),
                ...
                (p, m) => {
                    !w ||
                        ...
                        (E.current = E.current.then(async () => {
                            var P, U, M
                            const T = b.current
                            if (((b.current = new Set()), !T.size))
                                return
                            {
                                for (const k of ((P = n.rootSuite) ==
                                null
                                    ? void 0
                                    : P.allTests()) || [])
                                    if (T.has(k.id)) {
...
Make sure to serve the website (${window.location}) via HTTPS or localhost.`)
    ...
    Jt(document.querySelector('#root')).render(o.jsx(ve, {}))
})()
