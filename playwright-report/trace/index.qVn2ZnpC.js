...
const O = ({
    ...
    R = (r, c, s) => {
        ...
        if (s === 'left') {
            ...
            return { value: r.right - c, inBounds: r.right - c >= 0 }
    },
    V = () => {
    ...
    $ = () => {
        ...
        n.useEffect(() => {
            const t = async o => {
                ...
                if ((l = o.clipboardData) != null && l.files.length) {
                    ...
                    o.preventDefault(), L(o.clipboardData.files)
                }
            }
            return (
        ...
        const U = n.useCallback(
            ...
            W = n.useCallback(
                t => {
                    t.preventDefault(),
                        t.target.files && L(t.target.files)
                },
                [L]
            )
        n.useEffect(() => {
...
Make sure to serve the Trace Viewer (${window.location}) via HTTPS or localhost.`)
    ...
    A(document.querySelector('#root')).render(e.jsx($, {}))
})()
