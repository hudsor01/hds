import { n as bu, o as ku } from './defaultSettingsView-5nVJRt0A.js'
var ya = { exports: {} }
;(function (Et, zt) {
    ;(function (C, De) {
        Et.exports = De()
        ...
        function Lt(e, t, n) {
            for (
                ;
                (n < 0 ? t > 0 : t < e.length) && Me(e.charAt(t));
...
`,
        ...
        function Ir(e) {
            if (typeof e == 'string' && Ht.hasOwnProperty(e))
                e = Ht[e]
            else if (
                e &&
        ...
        function W(e, t) {
            return String(
                e.lineNumberFormatter(t + e.firstLineNumber)
            )
        }
        function L(e, t, n) {
        ...
        ;(Xt.prototype.lookAhead = function (e) {
            ...
            (Xt.prototype.save = function (e) {
                var t =
                    e !== !1
                        ? Gt(this.doc.mode, this.state)
                        : this.state
                return this.maxLookAhead > 0
                    ? new Hn(t, this.maxLookAhead)
                    : t
            })
        function go(e, t, n, r) {
        ...
        function xi(e, t, n, r) {
            ...
            for (
                o.start = o.pos = r || 0, t == '' && mo(i, n.state);
                !o.eol();
        ...
        function wa(e, t, n) {
            for (
                var r,
                    ...
                    l = n
                        ? -1
                        : t - (e.doc.mode.innerMode ? 1e3 : 100),
                    a = t;
                a > l;
                --a
            ) {
                ...
                if (
                    u &&
                    (!n ||
                        a + (u instanceof Hn ? u.lookAhead : 0) <=
                            o.modeFrontier)
                )
                    return a
        ...
        function Sa(e, t) {
            if (
                ...
                for (var n = e.first, r = t - 1; r > n; r--) {
                    ...
                    if (
                        i &&
                        (!(i instanceof Hn) || r + i.lookAhead < t)
                    ) {
                        n = r + 1
                        break
                    }
        ...
        function Aa(e, t, n) {
            ...
            for (
                ...
                for (
                    var l = r[o], a = l.find(0), s = 0;
                    s < i.length;
                    ++s
                ) {
                    var u = i[s]
                    if (
                        !(Z(u.to, a.from) < 0 || Z(u.from, a.to) > 0)
                    ) {
                        var h = [s, 1],
                            v = Z(u.from, a.from),
                            k = Z(u.to, a.to)
        ...
        function _a(e, t, n, r, i, o, l) {
            if (t) {
                var a = e.splitSpaces ? Ha(t, e.trailingSpace) : t,
...
`
                                ? ((E = h.appendChild(
                                  ...
                                  (e.col += 1))
                                : ((E =
                                      e.cm.options.specialCharPlaceholder(
                                          k[0]
                                      )),
                                  E.setAttribute('cm-text', k[0]),
                                  b && N < 9
        ...
        function Gn(e, t, n) {
            for (var r = [], i, o = t; o < n; o = i) {
                var l = new Oo(e.doc, ce(e.doc, o), o)
                ;(i = o + l.size), r.push(l)
            }
            return r
        }
        ...
        function $a(e, t) {
            ...
            return (
                (r.text = i.pre), J(e.display.lineMeasure, i.pre), r
            )
        }
        function Ro(e, t, n, r) {
        ...
        function qr(e, t) {
            ...
            r && !r.text
                ...
                : r &&
                  r.changes &&
                  (Po(e, r, n, Pi(e)), (e.curOp.forceUpdate = !0)),
                r || (r = $a(e, t))
            var i = Ho(r, t, n)
            return {
                line: t,
        ...
        function Zt(e, t, n, r, i) {
            ...
            return (
                t.cache.hasOwnProperty(o)
                    ...
                    : (t.rect ||
                          (t.rect =
                              t.view.text.getBoundingClientRect()),
                      t.hasHeights ||
                          (Va(e, t.view, t.rect),
                          (t.hasHeights = !0)),
                      (l = ts(e, t, n, r)),
        ...
        function ts(e, t, n, r) {
            ...
            if (o.nodeType == 3) {
                for (var h = 0; h < 4; h++) {
                    for (
                        ;
                        l && Me(t.line.text.charAt(i.coverStart + l));
                    ...
                    if (
                        ...
                        N < 9 &&
                        l == 0 &&
                        a == i.coverEnd - i.coverStart
                            ? (u =
                                  o.parentNode.getBoundingClientRect())
                            : (u = es(
                                  w(o, l, a).getClientRects(),
                                  r
                              )),
                        u.left || u.right || l == 0)
                    )
                ...
                b && N < 11 && (u = rs(e.display.measure, u))
            } else {
                l > 0 && (s = r = 'right')
                var v
                e.options.lineWrapping &&
                (v = o.getClientRects()).length > 1
            ...
            var Q = U ? R[U - 1] : 0,
                ...
                ee = {
                    left:
                        (s == 'right' ? u.right : u.left) -
                        t.rect.left,
                    right:
                        (s == 'left' ? u.left : u.right) -
                        t.rect.left,
                    top: Q,
                    bottom: G
                }
        ...
        function ns(e, t, n, r, i) {
            ...
            if (h) {
                var v = (e.options.lineWrapping ? os : is)(
                    e,
                    t,
                    n,
                    o,
            ...
            if (x) {
                ...
                ;(E = ee.left),
                    (U = i < ee.top ? -1 : i >= ee.bottom ? 1 : 0)
            }
            return (M = Lt(t.text, M, 1)), Ei(n, M, R, U, r - E)
        }
        ...
        function os(e, t, n, r, i, o, l) {
            ...
            return (
                h || (h = i[i.length - 1]),
                h.from < s &&
                    (h = { from: s, to: h.to, level: h.level }),
                h.to > u &&
                    (h = { from: h.from, to: u, level: h.level }),
                h
            )
        }
        var Sr
            ...
            if (
                ...
                s = L(
                    ...
                    Math.max(
                        0,
                        Math.round(
                            (o - _o(e.display).left) / Kr(e.display)
                        ) - h
                    )
                )
            }
        ...
        function ls(e, t, n) {
            ...
            i.length == 0 || t >= r.viewTo || n <= r.viewFrom
                ...
                : (r.viewFrom > t
                      ...
                      : r.viewFrom < t &&
                        (r.view = r.view.slice(Lr(e, t))),
                  (r.viewFrom = t),
                  r.viewTo < n
                      ? (r.view = r.view.concat(Gn(e, r.viewTo, n)))
                      : r.viewTo > n &&
                        (r.view = r.view.slice(0, Lr(e, n)))),
                (r.viewTo = n)
        }
        function $o(e) {
            for (
                ...
                if (!(!t && a == n.sel.primIndex)) {
                    ...
                    if (
                        ...
                        if (l) {
                            ...
                            (u ||
                                e.options.showCursorWhenSelecting) &&
                                Bi(e, s.head, i)
                        u || as(e, s, o)
                    }
                }
                ...
                ;(t.cursorDiv.style.visibility = ''),
                    e.options.cursorBlinkRate > 0
                        ? (t.blinker = setInterval(function () {
                              e.hasFocus() || Ur(e),
                                  (t.cursorDiv.style.visibility = (n =
                                      !n)
                                      ? ''
                                      : 'hidden')
        ...
        function tl(e) {
            e.hasFocus() ||
                (e.display.input.focus(), e.state.focused || Hi(e))
        }
        function _i(e) {
        ...
        function Vn(e) {
            for (
                var t = e.display,
                    ...
                    r = Math.max(
                        0,
                        t.scroller.getBoundingClientRect().top
                    ),
                    ...
                    if (((i += a.line.height), b && N < 8)) {
                        ...
                        ;(u = k.bottom - k.top),
                            !s &&
                                a.text.firstChild &&
                                (h =
                                    a.text.firstChild.getBoundingClientRect()
                                        .right -
                                    k.left -
                                    1)
                    }
            ...
            if (n && n.ensure) {
                ...
                a < o
                    ? ((o = a),
                      (l = g(
                          t,
                          er(ce(t, a)) + e.wrapper.clientHeight
                      )))
                    : Math.min(s, t.lastLine()) >= l &&
                      ((o = g(
                          t,
                          er(ce(t, s)) - e.wrapper.clientHeight
                      )),
                      (l = s))
            }
        ...
        function us(e, t, n, r) {
            ...
            for (var o = 0; o < 5; o++) {
                ...
                if (
                    (u.scrollTop != null &&
                        (yn(e, u.scrollTop),
                        Math.abs(e.doc.scrollTop - h) > 1 &&
                            (l = !0)),
                    u.scrollLeft != null &&
                        (Cr(e, u.scrollLeft),
                        Math.abs(e.doc.scrollLeft - v) > 1 &&
                            (l = !0)),
                    !l)
                )
                    break
        ...
        function hs(e) {
            ...
            for (var r = 0; r < t.length; r++) gs(t[r])
            for (var i = 0; i < t.length; i++) vs(t[i])
        ...
        function vs(e) {
            ...
            e.updatedDisplay && Vn(t),
                ...
                n.maxLineChanged &&
                    ...
                    ((e.adjustWidthTo =
                        Ro(t, n.maxLine, n.maxLine.text.length).left +
                        3),
        ...
        function ys(e) {
            ...
            if (
                ...
                e.scrollTop != null &&
                    il(t, e.scrollTop, e.forceScroll),
        ...
        function kn(e, t) {
            e.doc.highlightFrontier < e.display.viewTo &&
                e.state.highlight.set(t, ue(xs, e))
        }
        function xs(e) {
            var t = e.doc
                    ...
                    function (o) {
                        if (r.line >= e.display.viewFrom) {
                            ...
                            o.text.length <=
                                ...
                                r.nextLine()
                        if (+new Date() > n)
                            return kn(e, e.options.workDelay), !0
                    }
                ),
                    (t.highlightFrontier = r.line),
                    (t.modeFrontier = Math.max(
                        t.modeFrontier,
                        r.line
                    )),
                    i.length &&
        ...
        function ji(e, t) {
            ...
            return (
                ...
                Ss(e, n.updateLineNumbers, t.dims),
                s > 4 && (n.lineDiv.style.display = ''),
                (n.renderedView = n.view),
                ws(u),
                D(n.cursorDiv),
                D(n.selectionDiv),
                (n.gutters.style.height = n.sizer.style.minHeight =
                    0),
                a &&
                    ((n.lastWrapHeight = t.wrapperHeight),
                    (n.lastWrapWidth = t.wrapperWidth),
            ...
            for (
                ...
                if (!v.hidden)
                    if (!v.node || v.node.parentNode != o) {
                        ...
                        for (; l != v.node; ) l = a(l)
                        var x =
                            i && t != null && t <= u && v.lineNumber
                        v.changes &&
                            (oe(v.changes, 'gutter') > -1 && (x = !1),
                            Po(e, v, u, n)),
                            x &&
                                (D(v.lineNumber),
        ...
        function Ui(e) {
            ...
            ;(e.sizer.style.marginLeft = t + 'px'),
                ot(e, 'gutterChanged', e)
        }
        function Gi(e, t) {
            ;(e.display.sizer.style.minHeight = t.docHeight + 'px'),
                (e.display.heightForcer.style.top =
                    t.docHeight + 'px'),
            ...
            if (
                ...
                for (
                    ...
                    if (!n[l].hidden) {
                        e.options.fixedGutter &&
                            (n[l].gutter &&
                                (n[l].gutter.style.left = o),
                            n[l].gutterBackground &&
                                (n[l].gutterBackground.style.left =
                                    o))
                        var a = n[l].alignable
                        if (a)
        ...
        function fl(e) {
            ...
            if (n.length != r.lineNumChars) {
                ...
                return (
                    ...
                    (r.lineNumInnerWidth =
                        Math.max(o, r.lineGutter.offsetWidth - l) +
                        1),
        ...
        function cl(e) {
            ...
            for (var r = 0; r < n.length; ++r) {
                var i = n[r],
                    ...
                    l = i.style,
                    a = t.appendChild(
                        d('div', null, 'CodeMirror-gutter ' + o)
                    )
                l && (a.style.cssText = l),
                    o == 'CodeMirror-linenumbers' &&
                        ((e.lineGutter = a),
        ...
        function Ts(e, t, n, r) {
            ...
            ;(i.mover = d('div', [o], null, 'position: relative')),
                ...
                O &&
                    q >= 105 &&
                    (i.wrapper.style.clipPath = 'inset(0px)'),
                ...
                if (r && !l.empty() ? s > 0 : s >= 0) {
                    var u = _r(a.from(), l.from()),
                        ...
                        v = a.empty()
                            ...
                            : a.from() == a.head
                    o <= n && --n,
                        t.splice(--o, 2, new He(v ? h : u, v ? u : h))
                }
            }
            return new At(t, n)
        }
        ...
        function pl(e, t) {
            ...
            var n =
                ...
                r = e.ch
            return (
                e.line == t.to.line && (r += gr(t).ch - t.to.ch),
                L(n, r)
            )
        }
        function Yi(e, t) {
        ...
        function Ji(e, t, n, r) {
            ...
            if (t.full)
                ...
                o(
                    h,
                    h.text.slice(0, a.ch) + u[0] + v.text.slice(s.ch),
                    i(0)
                ),
                    e.remove(a.line + 1, M)
            else {
        ...
        function Ms(e, t) {
            if (t) return xl(e.done), ge(e.done)
        ...
        function Os(e, t, n) {
            ...
            return (
                ...
                r.ranges != t.ranges
                    ? Kt(e.cm, r.ranges, r.ranges.length - 1)
                    : t
            )
        }
        function Ll(e, t, n) {
            var r = e.history.done,
                i = ge(r)
            i && i.ranges
                ? ((r[r.length - 1] = t), li(e, t, n))
                : pt(e, t, n)
        }
        function pt(e, t, n) {
            li(e, t, n), As(e, e.sel, e.cm ? e.cm.curOp.id : NaN, n)
        }
        function li(e, t, n) {
            ...
            var r =
                (n && n.bias) ||
                (Z(t.primary().head, e.sel.primary().head) < 0
                    ? -1
                    : 1)
            Cl(e, Ml(e, t, r, !0)),
                !(n && n.scroll === !1) &&
        ...
        function Zr(e, t, n, r, i) {
            ...
            if (o.markedSpans)
                for (var l = 0; l < o.markedSpans.length; ++l) {
                    ...
                    if (
                        (a.from == null ||
                            (u ? a.from <= t.ch : a.from < t.ch)) &&
                        (a.to == null ||
                            (h ? a.to >= t.ch : a.to > t.ch))
                    ) {
                        if (
                            i &&
                            (Ye(s, 'beforeCursorEnter'),
                            s.explicitlyCleared)
                        )
                            if (o.markedSpans) {
                                --l
        ...
        function Nl(e, t) {
            if (
                ...
                var n = Yi(e, t)
                bl(e, t, n, e.cm ? e.cm.curOp.id : NaN),
                    Tn(e, t, n, ki(e, t))
                var r = []
                vr(e, function (i, o) {
                    !o &&
                        oe(r, i.history) == -1 &&
                        (zl(i.history, t), r.push(i.history)),
                        Tn(i, t, null, ki(i, t))
                })
            }
        }
        function si(e, t, n) {
            ...
            if (!(r && !n)) {
                for (
                    ...
                    u < a.length &&
                    ((o = a[u]),
                    !(n ? o.ranges && !o.equals(e.sel) : !o.ranges));
                    u++
                );
                if (u != a.length) {
        ...
        function Tn(e, t, n, r) {
            ...
            if (!(t.from.line > e.lastLine())) {
                if (t.from.line < e.first) {
                    var i =
                        t.text.length - 1 - (e.first - t.from.line)
                    Ol(e, i),
                        (t = {
                            from: L(e.first, 0),
                ...
                t.to.line > o &&
                    ...
                    n || (n = Yi(e, t)),
                    e.cm ? Ps(e.cm, t, r) : Ji(e, t, r),
                    li(e, n, Ve),
                    e.cantEdit &&
                        ai(e, L(e.firstLine(), 0)) &&
                        (e.cantEdit = !1)
            }
        }
        function Ps(e, t, n) {
        ...
        function Il(e, t, n, r) {
            for (var i = 0; i < e.length; ++i) {
                ...
                if (o.ranges) {
                    o.copied ||
                        ((o = e[i] = o.deepCopy()), (o.copied = !0))
                    for (var a = 0; a < o.ranges.length; a++)
                        Pl(o.ranges[a].anchor, t, n, r),
                            Pl(o.ranges[a].head, t, n, r)
                    continue
                }
        ...
        Cn.prototype = {
            ...
            removeInner: function (e, t) {
                for (var n = e, r = e + t; n < r; ++n) {
                    var i = this.lines[n]
                    ;(this.height -= i.height), Ia(i), ot(i, 'delete')
                }
        ...
        ;(mr.prototype.clear = function () {
                ...
                for (
                    ...
                    e && !this.collapsed
                        ...
                        : e &&
                          (a.to != null && (i = f(l)),
                          a.from != null && (r = f(l))),
                        (l.markedSpans = Ca(l.markedSpans, a)),
                        a.from == null &&
                            this.collapsed &&
                            !cr(this.doc, l) &&
                            e &&
            ...
            (mr.prototype.find = function (e, t) {
                ...
                for (var n, r, i = 0; i < this.lines.length; ++i) {
                    ...
                    if (
                        l.from != null &&
                        ((n = L(t ? o : f(o), l.from)), e == -1)
                    )
                        return n
                    if (
                        l.to != null &&
                        ((r = L(t ? o : f(o), l.to)), e == 1)
                    )
                        return r
                }
        ...
        function Vr(e, t, n, r, i) {
            if (r && r.shared) return zs(e, t, n, r, i)
            if (e.cm && !e.cm.curOp)
                return lt(e.cm, Vr)(e, t, n, r, i)
            var o = new mr(e, i),
                l = Z(t, n)
            if (
                (r && Te(r, o, !1),
        ...
        ;(kt.prototype = F(Dn.prototype, {
            ...
            getLineHandleVisualStart: function (e) {
                return (
                    typeof e == 'number' && (e = ce(this, e)), qt(e)
                )
            },
            lineCount: function () {
                return this.size
            ...
            setSelection: at(function (e, t, n) {
                Tl(this, Ce(this, e), Ce(this, t || e), n)
            }),
            ...
            setBookmark: function (e, t) {
                ...
                return (
                    (e = Ce(this, e)), Vr(this, e, e, n, 'bookmark')
                )
            },
...
`
        ...
        function Rs(e, t) {
            if (
                b &&
                (!e.state.draggingText || +new Date() - Hl < 100)
            ) {
                ar(t)
                return
            }
        ...
        function Ul(e, t, n) {
            ...
            return (
                ...
                (ze ? t.metaKey : t.ctrlKey) &&
                    r != 'Ctrl' &&
                    (e = 'Ctrl-' + e),
                (ze ? t.ctrlKey : t.metaKey) &&
                    r != 'Mod' &&
                    (e = 'Cmd-' + e),
                !n &&
                    t.shiftKey &&
        ...
        function Ys(e, t, n, r) {
            ...
            if (
                ...
                return to(t, n, r)
            var a = function (U, Q) {
                    return eo(t, U instanceof L ? U.ch : U, Q)
                },
                s,
                u = function (U) {
                    return e.options.lineWrapping
                        ? ((s = s || qr(e, t)), Qo(e, t, s, U))
...
`,
        ...
        function $l(e) {
            ...
            if (
                ...
                if (!(z && (!e.which || e.which < 10) && Jl(t, e))) {
                    var i = String.fromCharCode(r ?? n)
                    i != '\b' &&
                        (Vs(t, e, i) || t.display.input.onKeyPress(e))
                }
            }
        }
        var eu = 400,
        ...
        function ru(e, t, n, r, i) {
            ...
            return (
                r == 'double'
                    ...
                    : r == 'triple' && (o = 'Triple' + o),
                (o =
                    (t == 1 ? 'Left' : t == 2 ? 'Middle' : 'Right') +
                    o),
                On(e, Ul(o, i), i, function (l) {
                    if ((typeof l == 'string' && (l = Nn[l]), !l))
                        return !1
                    var a = !1
                    try {
                        e.isReadOnly() &&
        ...
        function nu(e, t, n) {
            ...
            return (
                ...
                i.addNew == null &&
                    (i.addNew = se ? n.metaKey : n.ctrlKey),
                i.moveOnDrag == null &&
        ...
        function iu(e, t, n, r) {
            b ? setTimeout(ue(tl, e), 0) : (e.curOp.focus = y(Y(e)))
            var i = nu(e, n, r),
                o = e.doc.sel,
                l
            e.options.dragDrop &&
        ...
        function lu(e, t, n, r) {
            ...
            if (
                ...
                var h = ta(e, n, r.unit)
                r.extend
                    ? (l = Vi(l, h.anchor, h.head, r.extend))
                    : (l = h)
            }
            r.addNew
                ? a == -1
                    ...
                    : u.length > 1 &&
                      ...
                      ? (pt(
                            ...
                            Kt(
                                e,
                                u.slice(0, a).concat(u.slice(a + 1)),
                                0
                            ),
            ...
            function k(G) {
                if (Z(v, G) != 0)
                    if (((v = G), r.unit == 'rectangle')) {
                        ...
                        Z(ft.anchor, nt) > 0
                            ? ((rt = ft.head),
                              (nt = _r(St.from(), ft.anchor)))
                            : ((rt = ft.anchor),
                              (nt = xt(St.to(), ft.head)))
                        var Qe = s.ranges.slice(0)
                        ;(Qe[a] = au(e, new He(Ce(o, nt), rt))),
                            pt(o, Kt(e, Qe, a), ct)
                    }
            }
        ...
        function au(e, t) {
            ...
            if (r.line != n.line)
                u =
                    (r.line - n.line) *
                        (e.doc.direction == 'ltr' ? 1 : -1) >
                    0
            else {
                var h = lr(o, r.ch, r.sticky),
                    v =
                        h - l ||
                        (r.ch - n.ch) * (a.level == 1 ? -1 : 1)
        ...
        function uu(e) {
            ...
            ;(e.defineOption = n),
                ...
                n('lineWrapping', !1, cu, !0),
                n(
                    'gutters',
                    [],
                    function (r, i) {
                        ;(r.display.gutterSpecs = Xi(
                            i,
                            r.options.lineNumbers
                        )),
                            wn(r)
                    },
                    !0
                ...
                n(
                    ...
                    function (r) {
                        al(r),
                            Xr(r),
                            r.display.scrollbars.setScrollTop(
                                r.doc.scrollTop
                            ),
                ...
                n('tabindex', null, function (r, i) {
                    return (r.display.input.getField().tabIndex =
                        i || '')
                }),
                n('autofocus', null),
                n(
        ...
        function cu(e) {
            e.options.lineWrapping
                ...
                : (Ee(e.display.wrapper, 'CodeMirror-wrap'), Li(e)),
                zi(e),
                bt(e),
                gn(e),
                setTimeout(function () {
        ...
        function Ge(e, t) {
            ...
            ;(this.options = t = t ? Te(t) : {}), Te(oa, t, !1)
            var r = t.value
            typeof r == 'string'
                ? (r = new kt(
                      r,
            ...
            ;(o.wrapper.CodeMirror = this),
                ...
                (t.autofocus && !ne) || this.hasFocus()
                    ...
                    : Ur(this)
            for (var l in di)
                di.hasOwnProperty(l) && di[l](this, t[l], tn)
        ...
        function du(e) {
            var t = e.display
            ve(t.scroller, 'mousedown', lt(e, ea)),
                b && N < 11
                    ? ve(
                          t.scroller,
                          'dblclick',
            ...
            ve(a, 'keyup', function (s) {
                ...
                ve(a, 'keydown', lt(e, Ql)),
                ve(a, 'keypress', lt(e, $l)),
...
`) &&
                ...
                for (
                    ...
                    if (
                        ...
                        if (o.electricChars) {
                            for (
                                var a = 0;
                                a < o.electricChars.length;
                                a++
                            )
                                if (
                                    t.indexOf(
                                        o.electricChars.charAt(a)
                                    ) > -1
                                ) {
                            ...
                            o.electricInput &&
                                o.electricInput.test(
                                    ce(e.doc, i.head.line).text.slice(
                                        0,
                                        i.head.ch
                                    )
                                ) &&
        ...
        function hu(e) {
            ...
            ;(e.prototype = {
                ...
                getTokenTypeAt: function (r) {
                    r = Ce(this.doc, r)
                    var i = vo(this, ce(this.doc, r.line)),
                        o = 0,
                        l = (i.length - 1) / 2,
                        a = r.ch,
                        s
                ...
                getModeAt: function (r) {
                    var i = this.doc.mode
                    return i.innerMode
                        ? e.innerMode(i, this.getTokenAt(r).state)
                              .mode
                        : i
                },
                ...
                execCommand: function (r) {
                    if (Nn.hasOwnProperty(r))
                        return Nn[r].call(null, this)
                },
                ...
                findPosH: function (r, i, o, l) {
                    ...
                    for (
                        ...
                        u < i &&
                        ((s = uo(this.doc, s, a, o, l)), !s.hitSide);
                        ++u
                    );
                    return s
                },
                ...
                scrollIntoView: vt(function (r, i) {
                    r == null
                        ? ((r = {
                          ...
                          i == null &&
                              (i = this.options.cursorScrollMargin))
                        : typeof r == 'number'
                ...
                setSize: vt(function (r, i) {
                    ...
                    r != null &&
                        (this.display.wrapper.style.width = l(r)),
                        i != null &&
        ...
        function uo(e, t, n, r, i) {
            ...
            function h(Q) {
                ...
                } else i ? (G = Ys(e.cm, a, t, n)) : (G = to(a, t, n))
                if (G == null)
                    if (!Q && u()) t = ro(i, e.cm, a, t.line, s)
                    else return !1
                else t = G
                return !0
            }
...
`))
            ...
            (je.prototype.pollContent = function () {
                ...
                if (
                    ...
                    return !1
                for (
                    var v = e.doc.splitLines(gu(e, a, h, l, u)),
                        k = Vt(
                            e.doc,
                            L(l, 0),
                            L(u, ce(e.doc, u).text.length)
                        );
            ...
            function k(x) {
                if (x.nodeType == 1) {
                    ...
                    if (x.getAttribute('contenteditable') == 'false')
                        return
                    var Q = /^(pre|div|p|li|table|br)$/i.test(
                        x.nodeName
                    )
                    if (
                        !/^br$/i.test(x.nodeName) &&
                        x.textContent.length == 0
                    )
                        return
                    Q && h()
                    for (var G = 0; G < x.childNodes.length; G++)
                        k(x.childNodes[G])
                    ;/^(pre|p)$/i.test(x.nodeName) && (s = !0),
                        Q && (l = !0)
                } else
                    x.nodeType == 3 &&
                        v(
...
`)),
            ...
            ve(i, 'cut', o),
                ...
                ve(e.scroller, 'paste', function (l) {
                    if (!(tr(e, l) || Ze(r, l))) {
                        ...
                        ;(a.clipboardData = l.clipboardData),
                            i.dispatchEvent(a)
                    }
                }),
            ...
            ($e.prototype.reset = function (e) {
                if (
                    ...
                    var t = this.cm
                    if (
                        ((this.resetting = !0), t.somethingSelected())
                    ) {
                        this.prevInput = ''
...
`) > -1
            ...
            ($e.prototype.onContextMenu = function (e) {
                ...
                a &&
                    n.doc.sel.contains(o) == -1 &&
                    lt(n, pt)(n.doc, pr(o), Ve)
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`)
                ...
                _ && (v = i.ownerDocument.defaultView.scrollY),
                    r.input.focus(),
                    _ &&
                        i.ownerDocument.defaultView.scrollTo(null, v),
                    r.input.reset(),
                    n.somethingSelected() ||
                        (i.value = t.prevInput = ' '),
    ...
    ;(function (C) {
        ...
        C.defineMode('css', function (fe, H) {
            ...
            function Ne(T, B) {
                ...
                if (F == '#')
                    return T.eatWhile(/[\w\\\-]/), oe('atom', 'hash')
                if (F == '!')
                    return (
                        T.match(/^\s*\w*/), oe('keyword', 'important')
                    )
            ...
            return (
                (Pe.top = function (T, B, F) {
                    ...
                    if (T == 'hash') be = 'builtin'
                        ...
                        if (T == 'variable-definition')
                            return 'maybeprop'
                        if (T == 'interpolation')
                            return Oe(F, B, 'interpolation')
                        if (T == ':') return 'pseudo'
                ...
                (Pe.atBlock = function (T, B, F) {
                    ...
                    if (T == '}' || T == ';') return et(T, B, F)
                    if (T == '{')
                        return Re(F) && Oe(F, B, xe ? 'block' : 'top')
                    if (T == 'interpolation')
                        return Oe(F, B, 'interpolation')
                    if (T == 'word') {
                        var Ie = B.current().toLowerCase()
                        ...
                        function se(d, S) {
                            for (var w; ; ) {
                                if (
                                    !d.context ||
                                    ((w = d.context.tagName),
                                    !b.contextGrabbers.hasOwnProperty(
                                        te(w)
                                    ) ||
                                        !b.contextGrabbers[
                                            te(w)
                        ...
                        function de(d, S, w) {
                            if (d == 'word') {
                                ...
                                return (
                                    w.context &&
                                        w.context.tagName != m &&
                                        b.implicitlyClosed.hasOwnProperty(
                                            te(w.context.tagName)
                                        ) &&
                                        ne(w),
                                    (w.context &&
                                        w.context.tagName == m) ||
                        ...
                        function H(d, S, w) {
                            ...
                            if (
                                ...
                                return (
                                    ...
                                    d == 'selfcloseTag' ||
                                    b.autoSelfClosers.hasOwnProperty(
                                        te(m)
                                    )
                                        ? se(w, m)
                                        : (se(w, m),
                            ...
                            indent: function (d, S, w) {
                                ...
                                if (
                                    ...
                                    return w
                                        ...
                                        : 0
                                if (d.tagName)
                                    return b.multilineTagIndentPastTag !==
                                        !1
                                        ? d.tagStart +
                                              d.tagName.length +
                                              2
                ...
                ;(function (C) {
                    ...
                    C.defineMode('javascript', function (De, I) {
                        ...
                        function re(f, g) {
                            ...
                            if (A == '`')
                                return (g.tokenize = Ae), Ae(f, g)
                            if (A == '#' && f.peek() == '!')
                                return (
                                    f.skipToEnd(), te('meta', 'meta')
                                )
                            if (A == '#' && f.eatWhile(ie))
                                return te('variable', 'property')
                            if (
                                (A == '<' && f.match('!--')) ||
                                (A == '-' &&
                                    f.match('->') &&
                                    !/\S/.test(
                                        f.string.slice(0, f.start)
                                    ))
                            )
                                return (
                                    f.skipToEnd(),
                        ...
                        function B(f, g) {
                            if (g == 'target')
                                return (D.marked = 'keyword'), d(Oe)
                        }
                        function F(f, g) {
                            if (g == 'target')
                                return (D.marked = 'keyword'), d(Re)
                        }
                        function Ie(f) {
                            return f == ':'
                                ? d(ue, Le)
                        ...
                        function ae(f) {
                            if (f == 'variable')
                                return (D.marked = 'property'), d()
                        }
                        function Se(f, g) {
                            if (f == 'async')
                                return (D.marked = 'property'), d(Se)
                            if (
                                f == 'variable' ||
                                D.style == 'keyword'
                            ) {
                                ...
                                if (_ && y(g))
                                    return (
                                        (D.marked = 'keyword'), d(Se)
                                    )
                                if (f == '[')
                                    return d(oe, or, Te(']'), Be)
                        ...
                        function Pt(f, g) {
                            ...
                            if (_ && g == '<')
                                return d(j('>'), Me(Bt, '>'), ue, Pt)
                        }
                        function ur(f, g) {
                            if (g == '*')
                                return (D.marked = 'keyword'), d(ur)
                        ...
                        function Rt(f, g) {
                            ...
                            if (
                                ...
                                return (
                                    (D.marked = 'property'), d(kr, Rt)
                                )
                            if (f == 'number' || f == 'string')
                                return d(kr, Rt)
                            if (f == '[')
                                return d(oe, or, Te(']'), kr, Rt)
                            if (g == '*')
                                return (D.marked = 'keyword'), d(Rt)
            ...
            function (ie, O) {
                var q = C.getMode(ie, {
                        ...
                        multilineTagIndentFactor:
                            O.multilineTagIndentFactor,
                        multilineTagIndentPastTag:
                            O.multilineTagIndentPastTag,
    ...
    ;(function (C) {
        ...
        C.defineMode('python', function (N, _) {
            ...
            var X = _.hangingIndent || N.indentUnit,
                ke = K,
                we = $
            _.extra_keywords != null &&
                (ke = ke.concat(_.extra_keywords)),
                _.extra_builtins != null &&
                    (we = we.concat(_.extra_builtins))
            ...
            function de(S, w, m) {
                ...
                if (S.match(ne)) {
                    var le =
                        S.current().toLowerCase().indexOf('f') !== -1
                    return le
            ...
            function ze(S, w) {
                for (
                    ;
                    'rubf'.indexOf(S.charAt(0).toLowerCase()) >= 0;
            ...
            function J(S, w) {
                ...
                if (
                    ...
                    if (
                        ...
                        if (V(w).type == y)
                            w.indent = w.scopes.pop().offset - X
                        else return ie
                }
                return (
                    w.dedent &&
            ...
            var d = {
                ...
                indent: function (S, w) {
                    if (S.tokenize != ye)
                        return S.tokenize.isString ? C.Pass : 0
                    var m = V(S),
                        y =
                            m.type == w.charAt(0) ||
                            (m.type == 'py' &&
                                !S.dedent &&
                                /^(else:|elif |except |finally:)/.test(
                                    w
                                ))
                    return m.align != null
                        ? m.align - (y ? 1 : 0)
    ...
    ;(function (C) {
        ...
        function V(m) {
            for (;;) {
                ...
                if (m.type == '}' && m.prev.info != 'namespace')
                    return !1
                m = m.prev
            }
        }
        C.defineMode('clike', function (m, y) {
            ...
            function T(ae, Se) {
                ...
                if ((ae.eatWhile(Ue), qe))
                    for (; ae.match(qe); ) ae.eatWhile(Ue)
                var Me = ae.current()
                return N(c, Me)
        ...
        function Ee(m, y) {
            ...
            function le(c) {
                if (c)
                    for (var Y in c) c.hasOwnProperty(Y) && P.push(Y)
            }
            le(y.keywords),
                le(y.types),
                le(y.builtin),
        ...
        Ee(['text/x-csrc', 'text/x-c', 'text/x-chdr'], {
            ...
            Ee('text/x-csharp', {
                ...
                defKeywords: b(
                    'class interface namespace record struct var'
                ),
                typeFirstDefinitions: !0,
                atoms: b('true false null'),
                hooks: {
            ...
            return function (y, P) {
                for (var le; (le = y.next()); )
                    if (le == '*' && y.eat('/'))
                        ...
                        return (
                            (P.tokenize = J(m + 1)), P.tokenize(y, P)
                        )
                return 'comment'
            }
        }
            ...
            (function (Et, zt) {
                ;(function (C) {
                    ...
                    ;(C.findModeByMIME = function (K) {
                        ...
                        if (/\+xml$/.test(K))
                            return C.findModeByMIME('application/xml')
                        if (/\+json$/.test(K))
                            return C.findModeByMIME(
                                'application/json'
                            )
                    }),
        ...
        C.defineMode(
            ...
            function (De, I) {
                ...
                I.highlightFormatting === void 0 &&
                    ...
                    I.maxBlockquoteDepth === void 0 &&
                        (I.maxBlockquoteDepth = 0),
                    I.taskLists === void 0 && (I.taskLists = !1),
                    I.strikethrough === void 0 &&
                        (I.strikethrough = !1),
                    ...
                    I.tokenTypeOverrides === void 0 &&
                        (I.tokenTypeOverrides = {})
                var b = {
                    header: 'header',
                    code: 'comment',
                    quote: 'quote',
                ...
                function de(p, c) {
                    var Y = p.column() === c.indentation,
                        ...
                        Te = c.list !== !1,
                        Le =
                            (c.listStack[c.listStack.length - 1] ||
                                0) + 3
                    c.indentedCode = !1
                        ...
                        if (
                            ...
                            return (
                                ...
                                (c.localMode =
                                    ...
                                    V(
                                        qe[2] ||
                                            I.fencedCodeBlockDefaultMode
                                    )),
                                c.localMode &&
                                    (c.localState = C.startState(
                                        c.localMode
                                    )),
                                (c.f = c.block = fe),
                                I.highlightFormatting &&
                                    (c.formatting = 'code-block'),
                                (c.code = -1),
                                H(c)
                            )
                        if (
    ...
    ;(function (C) {
        ...
        C.defineOption('placeholder', '', function (N, _, ie) {
            ...
            if (_ && !O)
                ...
                q.className = q.className.replace(
                    ' CodeMirror-empty',
                    ''
                )
            }
        ...
        function De(N) {
            N.state.placeholder &&
                (N.state.placeholder.parentNode.removeChild(
                    N.state.placeholder
                ),
                ...
                if (N.lineCount() == 1) {
                    ...
                    _ =
                        ie.nodeName == 'TEXTAREA'
                            ? !N.getLine(0).length
                            : !/[^\u200b]/.test(
                                  ie.querySelector('.CodeMirror-line')
                                      .textContent
                              )
                }
                _ ? I(N) : De(N)
...
;(function (Et, zt) {
    ;(function (C) {
            ...
            (C.simpleMode = function (O, q) {
                ...
                var Ae = {
                    ...
                    copyState: function (de) {
                        ...
                        de.localState &&
                            (ze.localState = C.copyState(
                                de.local.mode,
                                de.localState
                            )),
                            de.stack && (ze.stack = de.stack.slice(0))
                        for (
                            var fe = de.persistentStates;
                            fe;
                            fe = fe.next
                        )
                            ze.persistentStates = {
                ...
                if (X)
                    for (var ye in X)
                        X.hasOwnProperty(ye) && (Ae[ye] = X[ye])
                return Ae
            })
        function De(O, q) {
            if (!O.hasOwnProperty(q))
                throw new Error(
                    'Undefined state ' + q + ' in simple mode'
                )
        }
        function I(O, q) {
            if (!O) return /(?:)/
                        ...
                        se.data.next
                            ...
                            : se.data.push
                              ...
                              : se.data.pop &&
                                ...
                                (X.state = X.stack.pop()),
                            se.data.mode &&
                                N(q, X, se.data.mode, se.token),
                            se.data.indent &&
                                X.indent.push(
                                    z.indentation() + q.indentUnit
                                ),
        ...
        function b(O, q) {
            ...
            for (var X in O)
                if (O.hasOwnProperty(X)) {
                    if (!q.hasOwnProperty(X) || !b(O[X], q[X]))
                        return !1
                    z++
                }
        ...
        function N(O, q, z, X) {
            ...
            if (z.persistent)
                for (
                    var we = q.persistentStates;
                    we && !ke;
                    we = we.next
                )
                    (z.spec
                        ? b(z.spec, we.spec)
                        : z.mode == we.mode) && (ke = we)
        ...
        function ie(O, q) {
            return function (z, X, ke) {
                ...
                if (
                    ...
                    z.local ||
                    (q.dontIndentStates &&
                        _(z.state, q.dontIndentStates) > -1)
                )
                    return C.Pass
                ...
                e: for (;;) {
                    for (var re = 0; re < te.length; re++) {
                        ...
                        if (
                            ne.data.dedent &&
                            ne.data.dedentIfLineStart !== !1
                        ) {
                            var se = ne.regex.exec(X)
                            if (se && se[0]) {
                                we--,
                                    (ne.next || ne.push) &&
                                        (te = O[ne.next || ne.push]),
