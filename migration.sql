...
-- CreateEnum
CREATE TYPE "public"."LeaseType" AS ENUM ('FIXED_TERM', 'MONTH_TO_MONTH', 'WEEKLY', 'YEARLY');

-- CreateEnum
CREATE TYPE "public"."TenantStatus" AS ENUM ('ACTIVE', 'INACTIVE', 'PENDING', 'REJECTED');

-- CreateEnum
CREATE TYPE "public"."AuditAction" AS ENUM ('CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'ADMIN_ACCESS', 'SETTINGS_CHANGE', 'PASSWORD_RESET', 'EMAIL_CHANGE', 'ROLE_CHANGE');

-- CreateEnum
CREATE TYPE "public"."EntityType" AS ENUM ('PROPERTY', 'TENANT', 'LEASE', 'PAYMENT', 'MAINTENANCE', 'DOCUMENT');

-- CreateEnum
CREATE TYPE "public"."UserRole" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'PROPERTY_MANAGER', 'MAINTENANCE', 'TENANT', 'USER');

-- CreateEnum
CREATE TYPE "public"."LeaseStatus" AS ENUM ('ACTIVE', 'PENDING', 'EXPIRED', 'TERMINATED');
...
-- CreateEnum
CREATE TYPE "public"."ToolType" AS ENUM ('property_manager', 'project_manager', 'image_optimizer', 'document_manager');

-- CreateEnum
CREATE TYPE "public"."PaymentMethod" AS ENUM ('CREDIT_CARD', 'BANK_TRANSFER', 'CASH', 'CHECK');

-- CreateEnum
CREATE TYPE "public"."entity_type" AS ENUM ('USER', 'PROPERTY', 'TENANT', 'MAINTENANCE', 'PAYMENT', 'LEASE', 'DOCUMENT', 'SETTINGS', 'EMAIL_TEMPLATE', 'ROUTE');

-- CreateEnum
CREATE TYPE "public"."image_job_priority" AS ENUM ('low', 'medium', 'high');

-- CreateEnum
CREATE TYPE "public"."image_job_status" AS ENUM ('pending', 'processing', 'completed', 'failed');

-- CreateEnum
CREATE TYPE "public"."invoice_status" AS ENUM ('draft', 'pending', 'paid', 'overdue', 'cancelled');

-- CreateEnum
CREATE TYPE "public"."invoice_template_type" AS ENUM ('standard', 'custom');

-- CreateEnum
CREATE TYPE "public"."notification_type" AS ENUM ('system', 'maintenance', 'payment', 'lease', 'message', 'alert');

-- CreateEnum
CREATE TYPE "public"."payment_status" AS ENUM ('pending', 'paid', 'partial', 'late', 'overdue', 'cancelled', 'refunded');

-- CreateEnum
CREATE TYPE "public"."paymentcategory" AS ENUM ('RENT', 'SECURITY_DEPOSIT', 'LATE_FEE', 'MAINTENANCE', 'UTILITIES', 'OTHER');
...
-- CreateEnum
CREATE TYPE "public"."property_status" AS ENUM ('available', 'occupied', 'maintenance', 'renovation', 'off_market');
