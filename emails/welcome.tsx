    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>Thanks for joining our waitlist. You&apos;re currently in position #{position}.</Text>
          <Section style={section}>
            <Text style={text}>Want to move up the list? Share your referral code with friends:</Text>
            <Text style={code}>{referralCode}</Text>
            <Button style={button} href={`https://hudsondigitalsolutions.com/?ref=${referralCode}`}>
              Share Link
            </Button>
          </Section>
