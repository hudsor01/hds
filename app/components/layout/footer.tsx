        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
          <div className="mx-auto max-w-sm lg:max-w-none">
            <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
              Hudson Digital Solutions helps property managers streamline their operations with modern,
              efficient software solutions designed for today's real estate market.
            </p>
            ...
            <div className="mt-6 flex justify-center gap-4 lg:justify-start">
              {socialLinks.map((item) => (
                <a
                  key={item.name}
                  className="text-blue-400 transition hover:text-blue-500/75"
                  href={item.href}
                  target="_blank"
                  rel="noreferrer"
                >
