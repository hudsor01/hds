    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="container px-6 py-10 mx-auto">
        ...
        <p className="mt-4 text-gray-500 xl:mt-6 dark:text-gray-300">
          Discover how our property management platform can transform your business with these powerful
          features.
        </p>
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
          {features.map((feature) => (
            <div
              key={feature.name}
              className="p-8 space-y-3 border-2 border-blue-200 dark:border-blue-300 rounded-xl"
            >
              ...
              <Link
                href="/features"
                className="inline-flex p-2 text-gray-800 capitalize transition-colors duration-300 transform bg-blue-200 rounded-full rtl:-scale-x-100 dark:bg-blue-400 dark:text-white hover:underline hover:text-blue-400 dark:hover:text-blue-200"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6 h-6"
