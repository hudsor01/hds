...
import type { Lease, CreateLeaseInput } from '@/types/lease'
...
export default function LeasesPage() {
    ...
    async function fetchLeases() {
        ...
        `
            ...
            toast({
                title: 'Error',
                description:
                    'Failed to fetch leases. Please try again.',
                variant: 'destructive'
            })
        } finally {
            setIsLoading(false)
    ...
    async function handleDelete(leaseId: string) {
        try {
            ...
            setLeases(prev =>
                prev.filter(lease => lease.id !== leaseId)
            )
            toast({
                title: 'Success',
                    ...
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {selectedLease
                                ...
                                : 'Fill in the lease details below to add a new lease.'}
                        </DialogDescription>
                    </DialogHeader>
                    <LeaseForm
