...
export default function SettingsPage() {
        ...
        try {
            ...
            const data = {
                ...
                notifications_enabled:
                    formData.get('notifications_enabled') === 'true',
                email_notifications:
                    formData.get('email_notifications') === 'true',
                sms_notifications:
                    formData.get('sms_notifications') === 'true'
            }
    ...
    const handleSecuritySettingsSubmit = async (
        ...
        try {
            ...
            const data = {
                two_factor_enabled:
                    formData.get('two_factor_enabled') === 'true',
                two_factor_method: formData.get('two_factor_method'),
                max_sessions: parseInt(
                    formData.get('max_sessions') as string,
                    10
                ),
                login_notifications:
                    formData.get('login_notifications') === 'true'
            }
