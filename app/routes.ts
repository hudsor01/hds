...
export const routeMetadata = {
    '/': {
        ...
        description:
            'Simplify your property management with our comprehensive solution.'
    },
    '/about': {
        title: 'About Us - Hudson Digital Solutions',
        description:
            'Learn about our mission and vision in property management.'
    },
    '/features': {
        title: 'Features - Hudson Digital Solutions',
        description:
            'Discover the powerful features that make property management easier.'
    },
    '/pricing': {
        title: 'Pricing - Hudson Digital Solutions',
        description:
            'Transparent pricing plans for property management solutions.'
    },
    '/contact': {
