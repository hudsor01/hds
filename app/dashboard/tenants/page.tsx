        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase">Lease Ends</th>
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {tenants.map(tenant => (
              <tr key={tenant.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="inline-flex rounded-full bg-green-100 px-2 text-xs leading-5 font-semibold text-green-800 capitalize">
                    {tenant.status}
                  </span>
                </td>
