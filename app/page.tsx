          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            ...
            <motion.div variants={fadeInUp} className='space-y-8'>
              ...
              <div className='flex flex-col sm:flex-row gap-4'>
                {session ? (
                  <Button
                    className='w-full sm:w-auto bg-primary text-primary-foreground hover:opacity-90 animate-scale-in tap-scale transition-all duration-200'
                    asChild
                  >
                  ...
                  <>
                    ...
                    <Button
                      variant='outline'
                      className='w-full sm:w-auto border-primary text-primary hover:bg-primary/10 animate-scale-in tap-scale transition-all duration-200'
                      asChild
                    >
      ...
      >
        <div className='grid md:grid-cols-2 gap-8'>
          {[
            ...
            <Card
              key={i}
              className='p-6 bg-linear-to-br from-teal-soft/5 to-lavender/5 hover:from-teal-soft/10 hover:to-lavender/10 transition-colors border-pastel-blue-200/20'
            >
              <div className='flex flex-col gap-4'>
                <div className='text-teal-soft font-bold'>{'★'.repeat(5)}</div>
